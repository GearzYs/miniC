...
static const YYINT yylhs[] = {                           -1,
    0,   13,   13,   23,   23,   15,   16,   16,   17,   17,
   14,   14,   19,   19,   21,   21,   21,   22,   24,   24,
    8,    8,    8,    8,    8,    8,    7,    7,    7,    5,
    5,    5,    5,    5,    6,    6,    6,   11,    9,   10,
   20,   20,   12,   12,   12,   12,   12,   12,   18,   18,
   18,    4,    4,    4,    4,    3,    3,    3,    3,    3,
    3,    3,    3,    1,    1,    2,    2,    2,    2,    2,
    2,
};
...
static const YYINT yystos[] = {                           0,
  292,  305,  257,  258,  290,  306,  307,  311,  315,  311,
  283,  308,  309,  306,  311,  283,   40,   59,   44,   91,
  283,   40,  258,  313,  314,  283,  309,  284,  313,  283,
   44,   41,   93,   41,  314,  123,  301,   59,  305,  256,
  279,  280,  281,  283,  285,  286,  287,  288,  289,  297,
  298,  299,  300,  301,  302,  303,  311,  312,  316,   10,
   40,   40,   40,   40,   59,  260,  283,  284,   59,   40,
  304,  312,   58,  284,   40,   59,   91,   61,  125,  300,
  282,   40,  296,  304,  283,  303,  296,  304,  310,  304,
   40,  304,  259,  260,  261,  262,  263,  264,  265,  266,
   59,  295,  300,   58,  304,  304,  304,   40,  296,  304,
  267,  268,   41,  293,  269,  270,  271,  272,  273,  274,
  294,   59,   41,   44,   41,  310,   41,  304,  300,   41,
...
static const YYINT yygindex[] = {                         0,
  ...
  -55,  305,  126,  154,    0,    0,  146,   75,    1,  -18,
  145,  148,    0,    0,
};
...
static const YYINT yytable[] = {                         70,
  ...
  104,  108,   40,    3,    4,  122,  140,  145,  148,    1,
   37,   39,   14,   40,   27,  126,   29,   93,   94,   95,
   96,   97,   98,   99,  100,   41,   42,   43,   35,   44,
...
static const YYINT yycheck[] = {                         40,
  ...
  265,  266,   40,  284,   59,  144,  145,   58,  145,  148,
   ...
   32,   36,    9,  256,   19,   91,   22,  259,  260,  261,
  262,  263,  264,  265,  266,  279,  280,  281,   31,  283,
...
"fonction","declaration","liste_declarateurs","declarateur","liste_expressions",
"type","variable","liste_parms","parm","liste_fonctions","liste_instructions",
"illegal-symbol",
};
...
case 39:
#line 141 "miniC.y"
	{if (yystack.l_mark[-1].liste_noeud->nb_noeud == 0) {yyval.noeud=yystack.l_mark[-1].liste_noeud->liste_noeud[0];} else {yyval.noeud= creerNoeud("BLOC");
														yyval.noeud = appendChild1(yyval.noeud,yystack.l_mark[-2].noeud);
